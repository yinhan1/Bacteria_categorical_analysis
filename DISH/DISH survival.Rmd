...
Rows of missing death counts were removed.
...
Curves are cut off at 1%.

### Population replicates combined

```{r raw data replicates combined, fig.height=4, fig.width=10}
goal = gen125 %>% 
...
### Population replicate 1

```{r raw data replicate 1, fig.height=4, fig.width=10}
...
### Population replicate 2

```{r raw data replicate 2, fig.height=4, fig.width=10}
